...
<body>
  ...
  if(isset($_POST["src"])){
          ...
          <div class="row" style="margin-top:2%;">
            <div class="col-3" style="text-align:center;">';
              ...
              <div class="col-3" style="text-align:center;">
                ...
                <form action="" method="post"><button type="submit" class="btn btn-info" value="'.$flna.'" name="submit">DELETE</button></form>
              </div>
            </div>
          </div>';
        }
    ...
    if(isset($_POST["submit"])){
      ...
      $chdel="DELETE FROM flights WHERE Flight_no='$delfn'";
      if (mysqli_query($conn3,$chdel)){
        echo '<script>alert("Record Deleted Successfully")</script>';
      }
      else {
        echo "Error deleting record: " . mysqli_error($conn3);;
      }
    }
    ?>
  </body>
