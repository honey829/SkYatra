	...
	<div class="container">
     ...
     <!--php for righthand content-->
        <?php
          ...
          {
          echo'
        <h1 style="margin-left: 260px;">UPDATE USER</h1>
        ...
        <button style="margin-left:41%; padding: 20px;"  type="submit" name="sub" class="btn btn-info">Search</button>
          ...
          <div class="row">
           <div class="col-md-4">
            <form method="POST" action="update2user.php" enctype="multipart/form-data">
        ...
        <div class="f" style="margin-top:100px;">
         ...
         <div class="form-group">
           ...
           <div class="form-group">
             <label for="usr"></label>
            <input type="password" class="form-control" id="pass" name="pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="CHANGE PASSWORD" value="'.$pass.'"> <input type="checkbox" onclick="myFunction()"><p style="color:white;">Show Password</p>
         </div>
          <button style="margin-left:43%; margin-top:20px;" type="submit" class="btn btn-info">UPDATE</button>
         </div>
      </form>
      </div>
      </div>
