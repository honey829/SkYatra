...
<body style="background-image:url(image/bgimg.jpg);background-repeat:no-repeat;background-size:cover;opacity:0.8;">
  <div class="w3-top">
    <div class="w3-bar w3-white">
      <div class="container-fluid"> <!--container div-->
        <div style="background-color:#f9f9f9;" class="row">  <!--row div of logo-->
          <div class="col-9">  <!--column div of logo-->
          ...
          <div class="col-1 w3-dropdown-hover" style="margin-top:30px"><!--Dropdown Div start-->
            <button class="btn btn-info"><i class="far fa-life-ring"> Support</i></button>
            <div class="w3-dropdown-content" style="padding:0%;"><!--Dropdown-content Div start-->
              <a href="#" class="list-group-item" data-toggle="modal" data-target="#myModal1">Contact Us</a>
              <a href="#" class="list-group-item" data-toggle="modal" data-target="#myModal2">Feedback</a>
              <a href="#" class="list-group-item" data-toggle="modal" data-target="#myModal3">Flight Cancellation</a>
            </div><!--Dropdown-content Div end-->
          </div><!--Dropdown Div end-->
          <div class="col-2" style="margin-top:30px"> <!--col div of login-->
            <button data-toggle="modal" data-target="#myModal"class="btn btn-info"><i class="fa fa-sign-in-alt"> Login/Register</i></button>
  ...
  <div class="container" style="margin-top:10%;">
    ...
    if(isset($_POST["btn"])){
      ...
      echo'<button style="width:100%;"type="button" data-target="#sd" class="btn btn-info dropdown-toggle" data-toggle="collapse">
        <h3>'.$fc.' - '.$tc.'</h3>
        <p>1 adult | Economy</p>
      </button>';
    }
        ...
        <div class="container"><!--modal3 -->
          ...
          if(isset($_POST["btn"])){
            ...
            if(empty($_POST["rdate"]))
            {
              ...
              echo '<div class="container" style="color:black;font-weight:bold;margin-top:5%;">';
                while($res2=mysqli_fetch_assoc($res)){
                  ...
                  <div class="row" style="margin-top:2%;">
                    <div class="col-3" style="text-align:center;">';
                      ...
                      <div style="text-align:center;"class="col-2">
                        <h2>'.$arr_time[0].':'.$arr_time[1].'</h2>
                        <p>'.$city_to.'</p>
                      </div>
                      <div class="col-3" style="text-align:center;">
                        <h3>'.$price.'</h3>
                        <button type="button" onclick="book();" class="btn btn-info" name="book">Book</button>
                      </div>
                    </div>';
                  }
                  echo "</div>";
                  ...
                  $qu="select * from flights where City_from='$fc' AND City_to='$tc'";
                  $res=mysqli_query($conn,$qu);
                  echo '<div class="container" style="color:blue;margin-top:5%;">';
                    echo '<div class="row">
                      <h3>Departure</h3>
                    </div>';
                    while($res2=mysqli_fetch_assoc($res)){
